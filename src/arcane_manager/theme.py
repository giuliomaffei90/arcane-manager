...
DEFAULT_THEME_RGB: dict[str, tuple[float, float, float]] = {
    ...
    "adventure_reader_bg": (0x1A / 255, 0x1E / 255, 0x24 / 255),
    ...
    "copper": (0xC6 / 255, 0x7A / 255, 0x42 / 255),
    "no_cost": (0x76 / 255, 0xB7 / 255, 0xD8 / 255),
...
THEME_COLOR_LABELS = [
    ...
    ("adventure_reader_bg", "Adventure reader background"),
